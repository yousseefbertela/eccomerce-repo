    ...
    <>
      ...
      >
        <div className="container-custom">
          <div className="flex items-center py-4 md:py-6 w-full">
            {/* Logo left */}
            <Link
              to="/"
            ...
            <div className="flex items-center gap-4 ml-auto">
              {/* Search bar (Daily Paper style) */}
              <form className="hidden lg:flex items-center border-2 border-black rounded px-2 py-1 mr-2 bg-white" onSubmit={e => { e.preventDefault(); setIsSearchOpen(true); }}>
                <button
                  type="button"
                ...
                <input
                  ...
                  type="text"
                  placeholder="Search..."
                  className="bg-transparent focus:outline-none focus:ring-0 px-2 text-sm w-[120px]"
                  style={{ boxShadow: 'none', border: 'none', cursor: 'text' }}
                />
              </form>
