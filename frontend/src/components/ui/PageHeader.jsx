    ...
    >
      ...
      <div className={`container mx-auto px-4 relative z-10 h-full ${fullScreen ? 'flex flex-col justify-center items-center text-center' : ''}`}>
        ...
        <motion.h1 
          ...
          className={`${fullScreen ? 'text-5xl md:text-7xl lg:text-8xl' : 'text-4xl md:text-5xl lg:text-6xl'} font-['Archivo'] font-bold uppercase tracking-wider ${fullScreen ? 'mb-6' : ''}`}
        >
          <span className={backgroundImage ? 'bg-gradient-to-r from-white via-accent to-white bg-clip-text text-transparent drop-shadow-[0_0_30px_rgba(37,99,235,0.5)]' : 'text-black'}>
            {title}
          </span>
        </motion.h1>
